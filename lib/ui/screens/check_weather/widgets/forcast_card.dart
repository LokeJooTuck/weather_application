    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Padding(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return AspectRatio(aspectRatio: ratio, child: Image.asset('assets/images/weather_icons/HeavyRain.png', fit: BoxFit.fill, height: constraints.maxHeight, width: constraints.maxWidth * 0.5,));
                }
              ),
            ),
          ),
          ...
          Expanded(child: LayoutBuilder(
            builder: (context, constraints) {
              return Text('1-5', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white,),);
            }
          )),
          Expanded(child: LayoutBuilder(
            builder: (context,constraints) {
              return Text('km/h', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Colors.white, ),);
            }
          ))
